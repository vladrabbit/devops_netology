...
[Dockerhub](https://hub.docker.com/repository/docker/rabbitvlad/netology/general)
...
![Скриншот](https://github.com/vladrabbit/hw_img/blob/main/3.png)
...
![Скриншот](https://github.com/vladrabbit/hw_img/blob/main/task3-1.png)

Контейнер остановился по причине того, что командой attach связывается стандартный ввод и вывод с оболочкой хоста. Поэтому при нажатии Ctrl+C контейнер останавливается

6. Установите любимый текстовый редактор(vim, nano итд) с помощью apt-get.

![Скриншот](https://github.com/vladrabbit/hw_img/blob/main/task3-2.png)
...
![Скриншот](https://github.com/vladrabbit/hw_img/blob/main/task3-3.png)

11. * Это дополнительное, необязательное задание. Попробуйте самостоятельно исправить конфигурацию контейнера, используя доступные источники в интернете. >
12. Удалите запущенный контейнер "custom-nginx-t2", не останавливая его.(воспользуйтесь --help или google)

![Скриншот](https://github.com/vladrabbit/hw_img/blob/main/task3-4.png)
